...
namespace MiniBlink
{
    ...
    public class MenuItemDraw : System.Windows.Forms.ToolStripMenuItem
    {
        ...
        public void DrawSeparator(Graphics G, Rectangle Bounds)
        {
            ...
            //RenderSeparatorLine(G, Bounds, Color.Red, Color.Blue, Color.DarkGray, false);
            //ControlPaint.DrawReversibleLine( new Point(Bounds.X + 2, y), new Point(Bounds.X + Bounds.Width - 2, y), sepColor);
