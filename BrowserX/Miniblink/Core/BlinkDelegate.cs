...
namespace MiniBlinkPinvoke
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate uint wkeDownload2Callback(IntPtr webView, IntPtr param, int expectedContentLength, IntPtr url, IntPtr mime, IntPtr disposition, IntPtr job, IntPtr dataBind);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void wkeNetJobDataRecvCallback(IntPtr param, IntPtr job, IntPtr data, int length);

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void wkeNetJobDataFinishCallback(IntPtr param, IntPtr job, wkeLoadingResult result);
    ...
    public delegate void wkeOnNetGetFavicon(IntPtr webView, IntPtr param, IntPtr url, IntPtr buf);
    //wkeWebView webView, void* param, const utf8* url, wkeMemBuf* buf

    [UnmanagedFunctionPointer(CallingConvention.Cdecl, CharSet = CharSet.Auto)]
    public delegate IntPtr wkeGetTempCallbackInfo(IntPtr webView);
