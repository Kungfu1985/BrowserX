...
namespace MiniBlinkPinvoke
{
    ...
    public static class BlinkBrowserPInvoke
    {
        ...
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetNpapiPluginsEnabled(IntPtr webView, [MarshalAs(UnmanagedType.I1)] bool Enable);
        /// <summary>
        ...
        /// <param name="Enable"></param>
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetHeadlessEnabled(IntPtr webView, [MarshalAs(UnmanagedType.I1)] bool Enable);
        /// <summary>
        ...
        /// <param name="Enable"></param>
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetCspCheckEnable(IntPtr webView, [MarshalAs(UnmanagedType.I1)] bool Enable);
        /// <summary>
        /// 是否新开窗口
        /// </summary>
        /// <param name="webView"></param>
        /// <param name="Enable"></param>
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetNavigationToNewWindowEnable(IntPtr webView, [MarshalAs(UnmanagedType.I1)] bool Enable);
        ...
        /// <param name="Enable"></param>
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetTouchEnabled(IntPtr webView, [MarshalAs(UnmanagedType.I1)] bool Enable);
        /// <summary>
        /// 是否启用内存缓存
        /// </summary>
        /// <param name="webView"></param>
        /// <param name="Enable"></param>
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetMemoryCacheEnable(IntPtr webView, [MarshalAs(UnmanagedType.I1)] bool Enable);

        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeShowWindow(IntPtr webWindow, bool show);

        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetWindowTitle(IntPtr webWindow, string caption);

        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeSetWindowTitleW(IntPtr webWindow, [In] [MarshalAs(UnmanagedType.LPWStr)] string caption);
        ...
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr wkeGetTempCallbackInfo(IntPtr webView);
        ...
        /// <summary>
        /// 对js winows绑定一个属性访问器，在js里windows.XXX这种形式调用时，会触发c++中的fn函数。
        /// </summary>
        ...
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern long jsEvalExW(IntPtr es, [In] [MarshalAs(UnmanagedType.LPWStr)] string str, [MarshalAs(UnmanagedType.I1)] bool isInClosure);
        ...
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern wkeJSType jsTypeOf(Int64 v);


        //[DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        //public static extern jsType jsTypeOf(IntPtr es, Int64 v);
        ...
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern byte wkeIsWebRemoteFrame(IntPtr webView, IntPtr frameId);

        public static bool wkeIsWebRemoteFrameSelector(IntPtr webView, IntPtr frameId)
        {
            return wkeIsWebRemoteFrame(webView, frameId) != 0;
        }
        ...
        /// <param name="param"></param>
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeOnDownloadFile(IntPtr webView, wkeDownloadCallback callback, IntPtr param);
        
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeOnDownload(IntPtr webView, wkeDownloadCallback callback, IntPtr param);

        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeOnDownload2(IntPtr webView, wkeDownload2Callback callback, IntPtr param);
        ...
        [DllImport(BlinkBrowserdll, CallingConvention = CallingConvention.Cdecl)]
        public static extern void wkeNetGetFavicon(IntPtr webView, wkeOnNetGetFavicon callback, IntPtr callbackParam);
