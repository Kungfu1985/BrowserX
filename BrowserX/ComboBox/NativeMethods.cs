...
internal static class NativeMethods
{
    ...
    public interface PRINTDLG
    {
        ...
        IntPtr hPrintTemplate
        {
            get;
            set;
        }

        IntPtr hSetupTemplate
        {
            get;
            set;
        }
    ...
    public class PICTDESC
    {
        ...
        public static PICTDESC CreateBitmapPICTDESC(IntPtr hbitmap, IntPtr hpal)
        {
            ...
            pICTDESC.union2 = (int)((long)hpal & uint.MaxValue);
    ...
    public sealed class VARIANT
    {
        ...
        public static VARIANT FromObject(object var)
        {
            ...
            else if (!Convert.IsDBNull(var))
            {
                ...
                {
                    vARIANT.vt = 19;
                    vARIANT.data1 = (IntPtr)(long)Convert.ToUInt32(var, CultureInfo.InvariantCulture);
                }
        ...
        public object ToObject()
        {
            ...
            switch (num)
            {
                ...
                case 16:
                    ...
                    return (sbyte)(0xFF & (sbyte)(int)intPtr);
                case 17:
                    if (Byref)
                    {
                        intPtr = (IntPtr)(int)Marshal.ReadByte(intPtr);
                    }
                    return (byte)(0xFF & (byte)(int)intPtr);
                case 2:
                    if (Byref)
                    {
                        intPtr = (IntPtr)(int)Marshal.ReadInt16(intPtr);
                    }
                    return (short)(0xFFFF & (short)(int)intPtr);
                case 18:
                    if (Byref)
                    {
                        intPtr = (IntPtr)(int)Marshal.ReadInt16(intPtr);
                    }
                    return (ushort)(0xFFFF & (ushort)(int)intPtr);
                case 3:
                case 22:
                    if (Byref)
                    {
                ...
                case 21:
                    {
                        long ticks = (!Byref) ? ((uint)(((int)data1 & -1) | (int)data2)) : Marshal.ReadInt64(intPtr);
                        if (vt == 20)
                        {
                            return ticks;
                        }
                ...
                default:
                    ...
                    switch (num)
                    {
                        ...
                        case 6:
                            {
                                long ticks = (uint)(((int)data1 & -1) | (int)data2);
                        ...
                        default:
                            {
                                int num2 = vt;
                                throw new ArgumentException(("COM2UnhandledVT" + num2.ToString(CultureInfo.InvariantCulture)));
                            }
                    }
            }
        }
